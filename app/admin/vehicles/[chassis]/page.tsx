// app/admin/vehicles/[chassis]/page.tsx
'use client';
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="grid md:grid-cols-2 gap-4 mb-6">
          ...
          <div>
            ...
            {vehicle.customer_name && <p><strong>مشتری:</strong> {vehicle.customer_name}</p>}
          </div>
        </div>
              ...
              <div key={doc._id} className="border rounded-lg p-4 hover:bg-gray-50">
                <div className="flex justify-between items-start">
                  <div>
                    ...
                    <p className="mt-2 text-gray-700">{doc.text_content}</p>
                    {doc.image_url && (
                      <a 
                        href={doc.image_url} 
                        target="_blank" 
